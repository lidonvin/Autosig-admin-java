...
<%
    //获取request域中的数据
    //Homeinfo homeinfo = (Homeinfo) request.getAttribute("homeinfo") ;
%>
<div class="page-content clearfix">
 <div class="alert alert-block alert-success">
  <button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i></button>
  <i class="icon-ok green"></i>欢迎使用<strong class="green">邮件签名管理系统<small></small></strong>,你本次登陆时间为2022年7月12日13时34分，登陆IP:192.168.1.110.
 </div>
 <div class="state-overview clearfix">
         ...
         <div class="news_style">
          ...
          <ul class="list">
           <li><i class="icon-bell red"></i><a href="#">donvin.li更新了签名。</a></li>
