...
public class DBUtil {
    private static final String URL  ="jdbc:mysql://172.16.10.123:3306/exchange_log?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false" ;
    private static final String USERNAME  ="root" ;
    private static final String PASSWORD  ="123.com.cn" ;
    ...
    //通用的：查询总数
    public static int getCount(String sql ,Object[] params) {//select count(*) from xx where xxx;
        int count = -1 ;
        try {
